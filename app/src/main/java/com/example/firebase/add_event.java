    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new add_event.GetUrlContentTask(getApplicationContext()).execute("http://192.168.7.122/add_event.php?name="+txt1.getText().toString()+"&location="+txt2.getText().toString());

                //dref.push().setValue(mbr);
                dref.child("member"+i).setValue(mbr);
                Toast.makeText(add_event.this,"data inserted",Toast.LENGTH_LONG).show();
                i=i+1;
            }
        });
    }
